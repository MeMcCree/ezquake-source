...
setting settbinds_arr[] = {
	...
	ADDSET_SEPARATOR("TF"),
	ADDSET_BIND("Prime grenade of first type", "primeone"),
	ADDSET_BIND("Prime grenade of second type", "primetwo"),
	ADDSET_BIND("Throw primed grenade", "throwgren"),
	ADDSET_BIND("Reload", "reload"),
	ADDSET_BIND("Discard ammo", "discard"),
	ADDSET_BIND("Show flag info", "flaginfo"),
	ADDSET_BIND("Drop flag", "dropitems"),
	ADDSET_BIND("Choose scout", "scout"),
	ADDSET_BIND("Choose soldier", "soldier"),
	ADDSET_BIND("Choose pyro", "pyro"),
	ADDSET_BIND("Choose demoman", "demoman"),
	ADDSET_BIND("Choose heavy", "hwguy"),
	ADDSET_BIND("Choose engineer", "engineer"),
	ADDSET_BIND("Choose medic", "medic"),
	ADDSET_BIND("Choose sniper", "sniper"),
	ADDSET_BIND("Choose spy", "spy"),
	ADDSET_BIND("Classchange menu", "changeclass"),
	ADDSET_BASIC_SECTION(),
